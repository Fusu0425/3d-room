...
当前版本为 `V2.4 · MOBILE FOCUS`：手机端点击书架会先进入近景，再从清晰书脊或封面选择具体书籍；白板使用独立的高清阅读卡片，并保留直接编辑入口。公开参观页面可在手机上创建只保存在当前设备中的个人副本，继续添加照片、视频、读书摘录和白板内容，彼此互不影响。两张游戏海报仍保留全屏游戏剧场、播放控制、进度和概念音景。
